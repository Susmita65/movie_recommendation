...
import 'package:sstfix/Onboarding%20Page/Language%20Selection/components/LanguageChips.dart';
import 'package:sstfix/Splash/SplashScreen.dart';
...
class _CollaborativeHomePageState extends State<CollaborativeHomePage> {
  ...
  String secondary_url =
      "https://api.themoviedb.org/3/movie/popular?api_key=2c5341f7625493017933e27e81b1425e&with_original_language=";
  @override
  void initState() {
      ...
      child: Column(
        children: [
          ...
          recommemdedmovieimages.isEmpty
              ? SizedBox()
              : TopShimmerWithoutURL("Movies You Liked"),
