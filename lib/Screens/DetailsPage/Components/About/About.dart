...
class _AboutState extends State<About> {
  ...
  void getpopularresponse() async {
    var response = await Dio().get("https://api.themoviedb.org/3/movie/" +
        widget.id.toString() +
        "?api_key=2c5341f7625493017933e27e81b1425e&language=en-US");
  ...
  void getcompanies() async {
    var response = await Dio()
        .get("${Api.baseUrl}getmovie/" + widget.moviename);
    var data = response.data;
  ...
  void getcrewdetails() async {
    var response = await Dio().get("https://api.themoviedb.org/3/movie/" +
        widget.id.toString() +
        "/credits?api_key=2c5341f7625493017933e27e81b1425e");
    var data = response.data;
    try {
      setState(() {
        crew = data["cast"];
  ...
  void getdirector() async {
    var response = await Dio()
        .get("${Api.baseUrl}getdirector/" + widget.moviename);
    var data = response.data;
    try {
      setState(() {
        director = data;
